...
void firstExp() {
    ...
    cout << "number1 is : " << number1 << " and the size of first number is : " << sizeof(number1) << endl; //7 digits
    ...
    // long double number4  {192400023.0e6};               // Error : narrowing conversion
...
void SecondExp() {
    ...
    double secondSpecial {1.00000000003498};
    ...
    cout << "secondSpecial is : " << secondSpecial << endl;
...
void thirdExp() {
    ...
    double number13{ 5.6};  // try positive number  
    ...
    cout << number13 << "/" << number11 << " positive yields " << result << endl;
